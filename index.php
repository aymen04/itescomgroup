...
<body>
    ...
    // Récupérer le statut à partir de $_GET['statut']
    $statut = isset($_GET['statut']) ? $_GET['statut'] : '';

    // Afficher le message correspondant en fonction du statut
    if ($statut === 'success') {
      echo '<div class="success-message" style="background-color: #dff0d8;
      color: #3c763d;
      padding: 15px;
      border: 1px solid #d6e9c6;
      text-align: center;
      width: 50%;
      margin: auto;">Message envoyé avec succès !</div>';
    } elseif ($statut === 'error') {
